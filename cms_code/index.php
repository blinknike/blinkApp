    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">CACM site</a>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <b class="bg bg-success">CACM site to display Digital video instruction registration and manipulation</b> 
                        </h1>
             ...
             <div class="col-lg-12">
                        <h2 class="btn btn-primary">List of Records for registration on the digital video instruction</h2> <a href="add.php?action=add" type="button" class="btn btn-xs btn-info">Add New</a>
